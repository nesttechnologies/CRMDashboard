...
<body style="background-color: #000000">
    ...
    <div style="margin-left:auto;margin-right:auto; font-family: 'Arial Narrow'; color: #FFFFFF;" class="auto-style2">
        ...
        <table cellpadding="4">
            ...
            <td class="auto-style1">
              ...
              <td class="auto-style4">
               <asp:DropDownList ID="DropDownList1" runat="server" Height="17px" Width="376px">
            ...
            <tr>
             ...
             <tr>
                ...
                <asp:DropDownList ID="States" runat="server" Height="19px" Width="201px" OnInit="GetStates"> </asp:DropDownList>
        ...
        <table cellpadding="4">
            <tr>
                ...
                <td class="auto-style9">
                    <asp:DropDownList ID="OrgSizeEmpl" AutoPostBack="True" runat="server" Height="18px" Width="215px" CssClass="auto-style8">
            ...
            <tr>
                ...
                <td class="auto-style9"> 
                    <asp:DropDownList ID="OrgSizeTurnover" AutoPostBack="True" runat="server" Height="18px" Width="215px" CssClass="auto-style8">
