        ...
        private string GetColor2()
        {
            ...
            if (dataDB != "Click 'GO' ")
            {
                ...
                for (int i = 0; i <9; i++)
                {
                    ...
                    {
                        o1["data"][i]["color"]= string.Format("{0}", "#E63287");
                    }
                    else
                    {
                        o1["data"][i]["color"] = string.Format("{0}", "#2E59E5");
                    }
        ...
        private string GetColor()
        {
            ...
            if (dataDB != "Click 'GO' ")
            {
                ...
                for (int i = 9; i > 0; i--)
                {
                    ...
                    {
                        o1["data"][i]["anchorBgColor"] = string.Format("{0}", "#E63287");
                        o1["data"][i]["anchorRadius"] = string.Format("{0}", "6");

                    }
                    else
                    {
                        o1["data"][i]["anchorBgColor"] = string.Format("{0}", "E1f5ff");
                        // o1["data"][i - 1]["color"] = string.Format("{0}", "#0000ff");
            ...
            if (dataDB[0] != "Click 'GO' ")
            {
                ...
                for (int i = 0; i < 5; i++)
                {
                    ...
                    if (y1 == x1 && x1 != 0)
                    {
                        ...
                        o2["data"][i]["color"] = string.Format("{0}", "#E63287");
                    ...
                    else
                    {
                        ...
                        o2["data"][i]["color"] = string.Format("{0}", "#2E59E5");
                        // o1["data"][i - 1]["color"] = string.Format("{0}", "#0000ff");
                    }
                    if (i < 3)
                    {
                        ...
                        if (y2 == x2 && x2 != 0)
                        {
                            ...
                            o3["data"][i]["color"] = string.Format("{0}", "#E63287");

                        }
                        else
                        {

                            o3["data"][i]["color"] = string.Format("{0}", "#2E59E5");
                            // o1["data"][i - 1]["color"] = string.Format("{0}", "#0000ff");
                        }
                    }
                }
